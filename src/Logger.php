...
class Logger implements \Psr\Log\LoggerInterface
{
	...
	public function debug($msg, array $c = null)
	{
		return $this->log(self::LEVELS[LogLevel::DEBUG], $msg, $c);
	}
	public function info($msg, array $c = null)
	{
		return $this->log(self::LEVELS[LogLevel::INFO], $msg, $c);
	}
	public function notice($msg, array $c = null)
	{
		return $this->log(self::LEVELS[LogLevel::NOTICE], $msg, $c);
	}
	public function warning($msg, array $c = null)
	{
		return $this->log(self::LEVELS[LogLevel::WARNING], $msg, $c);
	}
	public function error($msg, array $c = null)
	{
		return $this->log(self::LEVELS[LogLevel::ERROR], $msg, $c);
	}
	public function critical($msg, array $c = null)
	{
		return $this->log(self::LEVELS[LogLevel::CRITICAL], $msg, $c);
	}
	public function alert($msg, array $c = null)
	{
		return $this->log(self::LEVELS[LogLevel::ALERT], $msg, $c);
	}
	public function emergency($msg, array $c = null)
	{
		return $this->log(self::LEVELS[LogLevel::EMERGENCY], $msg, $c);
	}
	...
	public function log($level, $msg, array $c = null): void
	{
		...
		if (isset($c)) {
			$this->current_msg .= ", " . print_r($c, true);
		};
		$ref = array();
	...
	{
		return $this->logAtThisLevel(LogLevel::DEBUG);
	}
	public function is_info()
	{
		return $this->logAtThisLevel(LogLevel::INFO);
	}
	public function is_notice()
	{
		return $this->logAtThisLevel(LogLevel::NOTICE);
	}
	public function is_warning()
	{
		return $this->logAtThisLevel(LogLevel::WARNING);
	}
	public function is_error()
	{
		return $this->logAtThisLevel(LogLevel::ERROR);
	}
	public function is_critical()
	{
		return $this->logAtThisLevel(LogLevel::CRITICAL);
	}
	public function is_alert()
	{
		return $this->logAtThisLevel(LogLevel::ALERT);
	}
	public function is_emergency()
	{
		return $this->logAtThisLevel(LogLevel::EMERGENCY);
	}
