...
final class ControllerTest extends TestCase
{
	...
	public function testRunController(): void
	{
		...
		$this->assertNull($err);
		$err = $t->Do_sqls(
			"INSERT INTO testing (m_id,x,y,z) VALUES (?,?,?,?)",
			array(1, "aaa", "zzz", "1"),
			array(1, "bbb", "yyy", "1"),
			array(1, "ccc", "xxx", "1"),
			array(1, "ddd", "www", "1"),
		...
		$resp = $controller->Run();
		$this->assertEquals(200, $resp->code);
		$this->assertEquals('{"success":true,"incoming":{"action":"edit","id":4,"email":"aaa","m_id":"1","first_name":"f","last_name":"l","address":"a","company":"c"},"data":[{"x":"ddd","y":"www","z":"1","id":"4","id_md5":"WBDuVepn54OOmgFH5TllK3ccX0Euok_SBby2pJEBjqc"}],"included":{"csrf_token":"AAAAAE_CbxN0zA2c7g-Jw_sYoPJLwhnhRNYtBgUc0tHtV9rn","cache_url":"\/bb\/m\/t\/4.json","json_url":"\/bb\/m\/json\/t?action=edit"}}', $resp->report(self::getRender($resp, $c)));
